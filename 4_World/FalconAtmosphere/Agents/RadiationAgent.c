class RadiationAgent extends AgentBase
{
	override void Init()
	{
		m_Type 					= AtmosphereConstants.RADIATION_AGENT_ID;
		...
		m_DieOffSpeed = 0.001;//how fast the agent dies off when not potent enough to grow(per sec)
	}
}